 ...
 *
 * Timeline (0.0s - 3.7s):
 * - 0.00s–0.25s: Blank pure white screen
 * - 0.25s–0.65s: Stroke 1 (Upper large wing) progressively drawn
 * - 0.50s–0.90s: Stroke 2 (Second thinner wing) progressively drawn
 * - 0.75s–1.15s: Stroke 3 (Central body & 'S' shape) drawn
 * - 1.00s–1.35s: Stroke 4 (Lower wing/tail) drawn
 * - 1.15s–1.45s: Stroke 5 (Head/Beak shape) drawn
 * - 1.35s–1.75s: Complete bird logo scales with subtle overshoot (0.90 -> 1.025 -> 1.00)
 * - 1.65s–2.10s: Rounded-square gradient background forms; bird morphs from orange to white
 * - 2.10s–2.50s: App icon settles with soft ambient glow
 * - 2.50s–2.90s: "Swift" title reveals with slide-up & fade
 * - 2.90s–3.20s: "All-in-One PDF Utility" subtitle reveals
 * - 3.20s–3.50s: Full splash hold
 * - 3.50s–3.70s: Smooth fade/scale transition to app home
 */
@Composable
fun SplashScreen(
